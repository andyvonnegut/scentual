...
export function SignInButton({ next }: { next?: string }) {
  ...
  return (
    <button
      ...
      onClick={signIn}
      disabled={pending}
      className="inline-flex items-center gap-2 rounded-[var(--radius-pill)] border border-[color:var(--line)] bg-[color:var(--bg-elevated)] px-5 py-2.5 text-sm font-medium hover:border-[color:var(--accent)] hover:text-[color:var(--accent-strong)] disabled:opacity-60"
    >
      <GoogleGlyph />
